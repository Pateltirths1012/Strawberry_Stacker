...
# Calling the rosservices
    ...
    def wpPush(self,index,wps):
        ...
        try:
            missionPush = rospy.ServiceProxy('mavros/mission/push', mavros_msgs.srv.WaypointPush)
            missionPush(index,wps)
        except rospy.ServiceException as e:
            print("Service mission_push call failed: %s"%e)
